...
class AppStyle {
  static TextStyle txtPlusJakartaSansBold18Gray901 = TextStyle(
  ...
  static TextStyle txtPlusJakartaSansSemiBold12Gray600 = TextStyle(
    color: ColorConstant.gray600,
    fontSize: getFontSize(
      12,
    ),
  ...
  static TextStyle txtPlusJakartaSansSemiBold16Gray907 = TextStyle(
    color: ColorConstant.gray907,
    fontSize: getFontSize(
      16,
    ),
