import '../applied_job_screen/widgets/applied_job_item_widget.dart';
import 'controller/applied_job_controller.dart';
import 'models/applied_job_item_model.dart';
                                        ...
                                        Container(
                                            ...
                                            child: Obx(() => ListView.builder(
                                                ...
                                                itemBuilder: (context, index) {
                                                  AppliedJobItemModel model =
                                                      controller
                                                              .appliedJobModelObj
                                                              .value
                                                              .appliedJobItemList[
                                                          index];
                                                  return AppliedJobItemWidget(
                                                      model);
                                                }))),
                                        Padding(
